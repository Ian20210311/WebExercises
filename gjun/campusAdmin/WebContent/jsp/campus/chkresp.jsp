      ...
      <div class="container">
        <div class="row">
          ...
          <%@include file="../../html/bodyleft.htm" %>
            ...
            <div class="col-sm-8">
              <h2>寄發Email</h2>
              <div><img src="../../img/campus.jpg" class="img-responsive" alt="Cinque Terre" width="800" height="50">
              </div>
              <br>
              <br>
              <form class="form-horizontal" role="form" action="chkresp.jsp" method="POST">
                <div class="form-group">
                  <label for="firstname" class="col-sm-6 control-label">已將您到校時間寄發email給貴家長!!</label>
                </div>
              </form>
            </div>
        </div>
